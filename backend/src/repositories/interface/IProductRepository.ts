...
export interface IProductRepository {
    ...
    updateProduct(id: string, userId: string, product: Partial<ProductsDocument>): Promise<ProductsDocument>;
    ...
    getAllProducts(userId: string, search?: string, page?: number, limit?: number): Promise<{ products: ProductsDocument[], totalCount: number }>;
}