...
const SalesPage = () => {
  ...
  const columns: Column<SaleTypes>[] = [
    ...
    },
    {
      header: 'Total Qty',
      accessor: (s: SaleTypes) => (
        <span className="text-emerald-400 font-medium">{s.items.reduce((sum, i) => sum + i.quantity, 0)} items</span>
      ),
    },
    {
  ...
  return (
    <DashboardLayout>
      ...
      <AddEditModal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} title="Create New Invoice">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <button
                    type="button"
                    onClick={() =>
                      setFieldValue('items', [...values.items, { productId: '', quantity: 1, price: 0, _tempName: '' }])
                    }
                        ...
                        >
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <SearchableSelect
                              ...
                              error={
                                typeof errors.items?.[index] === 'object' ? errors.items[index]?.productId : undefined
                              }
                              touched={
                                typeof touched.items?.[index] === 'object' ? touched.items[index]?.productId : undefined
                              }
                            />
      ...
      <AddEditModal isOpen={isViewModalOpen} onClose={() => setIsViewModalOpen(false)} title="Invoice Details">
        {selectedSale && (
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4 p-4 bg-[#0d1117] rounded-xl border border-[#1a1f2a]">
              ...
              <div className="space-y-1">
                ...
                <div className="text-sm font-medium text-emerald-400">{selectedSale.customerName || 'Cash Sale'}</div>
              </div>
            </div>
