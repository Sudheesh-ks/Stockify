      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          ...
          <div className="flex gap-2">
            <button
              ...
              className="flex items-center gap-2 px-3 py-2 bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 hover:bg-emerald-500/20 rounded-lg transition-all"
            >
            ...
            <button
              onClick={exportToPDF}
              className="flex items-center gap-2 px-3 py-2 bg-red-500/10 text-red-500 border border-red-500/20 hover:bg-red-500/20 rounded-lg transition-all"
            >
        ...
        <div className="bg-[#0d1117] rounded-2xl border border-[#1a1f2a] overflow-hidden">
          <div className="p-6 border-b border-[#1a1f2a]">
            <h2 className="text-lg font-bold text-white capitalize">{activeTab} Summary</h2>
          </div>
